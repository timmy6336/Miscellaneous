...
Description:
 - This PHP file contains the "Region" php logic page for Kanto Spirit.
 - Takes in a Region by the user, and outputs a table containing the: Name, Type, Ability, Generation, and Image of pokemon that match the query
 */
?>
        ...
        <div class="jumbotron">
            ...
            <html>
                ...
                <body>
                    ...
                    ?>
                    <h1> Searching for all Pokemon in region: <?php
                        echo $last_name ?></h1>
                    <table>
                        <tr id="headerRow">
                            <th>Name</th>
                        ...
                        /* Takes a Region from user, and output as a table the following attributes of the matching PokeMon:
                            - Name, Type, Ability, Generation, Image*/
                        $sql = "SELECT *
                                FROM POKEMON, GENERATION
                                WHERE GENERATION.Region = '{$last_name}'
                                AND GENERATION.GenNum = POKEMON.GenNum";
