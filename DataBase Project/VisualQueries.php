...
Description:
 - This PHP file contains the main "VisualQueries" page for Kanto Spirit.
 - Provides buttons to proceed to the "Search By Color" or "Search By Height" queries.
 */
?> 
...
<html lang="en">
    ...
    <body>
        ...
        <div class="center">
            <div class="row">
                <div class="column">
                    <input type="image" id="image" alt="Login" src="/groupAssignment/images/SearchC.png">
                </div>
                <div class="column">
                    <input type="image" id="image" alt="Login" src="/groupAssignment/images/SearchH.png">
                </div>
            </div>
            <div class="container">
                <div class="center">
