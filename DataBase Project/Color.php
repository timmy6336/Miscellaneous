...
Description:
 - This PHP file contains the "Color" page php query logic for Kanto Spirit.
 - Takes in a Color by the user, and outputs a table containing the: Name, Type, Ability, Generation, and Image of pokemon that match the query
 */
?>
        ...
        <div class="jumbotron">
            ...
            <html>
                ...
                <body>
                    ...
                    ?>
                    <h1> Searching for all Pokemon of color: <?php
                        echo $last_name ?></h1>
                    <table>
                        <tr id="headerRow">
                            <th>Name</th>
                        ...
                        /* Takes a color from the user, and output as a table the following attributes of the matching PokeMon:
                            - Name, Type, Ability, Generation, Image*/
                        $sql = "SELECT *
                                FROM POKEMON, VISUALS
                                WHERE VISUALS.Color = '{$last_name}'
                                AND VISUALS.Pname = POKEMON.PNAME";
