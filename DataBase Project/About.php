...
Description:
 - This PHP file contains the "About" page for Kanto Spirit.
  - Contains a description of our project, and a list of the people who made it.
 */
?>
...
<html lang="en">
    ...
    <body>
        ...
        <div class="jumbotron">
                <h1>Kanto  Spirit's  mission: </h1>
            <h3>Kanto Spirit 
                aims to create a simple, yet rewarding database for Pokemon fans everywhere. 
                The member's of Kanto Spirit wanted to connect Pokemon fans to their favorite Pokemon 
            in new, more personable ways. Users can now search for Pokemon based on particular visual criteria and
            find their spirit Pokemon, while still being able to search for Pokemon in traditional ways.</h3>
            
            <h1> Meet  the  team:  </h1>
            <h3 id="name"> Timmy Roma </h3>
            <h4> Timmy6336@gmail.com </h4>
            <h3 id="name"> Gregory Habutzel </h3>
            <h4> greghab@uw.edu </h4>
            <h3 id="name"> Ella Gainey </h3>
            <h4>audreyeg@uw.edu</h4>
        </div>
        <style>
            ...
            /* about page h3 styling */
            .jumbotron h3 {
                font-family: Hisel;
                word-spacing: 5px;
            }
            
            /* about page name element styling */
            #name {
                font-family: Hisel;
                text-align:center
            }
            
            /* about page h4 styling */
            .jumbotron h4 {
                font-family: Hisel;
                text-align:center
            }
